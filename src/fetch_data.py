...
def upsert_committees(period_id: int, mandate_to_politician: dict[int, int]) -> None:
    ...
    """
    log.info("Fetching committees for period %d...", period_id)
...
def main() -> None:
    ...
    upsert_committees(period_id, mandate_to_politician)
